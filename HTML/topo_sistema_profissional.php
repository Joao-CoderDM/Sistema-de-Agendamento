...
<head>
    ...
    <title>Sistema Profissional - Barbearia Mosanberk</title>
    ...
    <!-- CSS Personalizado -->
    <link rel="stylesheet" href="../CSS/Profissional/sistema_profissional.css">
...
<body>
        ...
        <div class="container-fluid px-4">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    <li class="nav-item">
                        <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'sistema_profissional.php') ? 'active' : ''; ?>" href="sistema_profissional.php">
                            <i class="bi bi-house me-1"></i>Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'agenda_profissional.php') ? 'active' : ''; ?>" href="agenda_profissional.php">
                            <i class="bi bi-calendar-check me-1"></i>Agenda
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'profissional_clientes.php') ? 'active' : ''; ?>" href="profissional_clientes.php">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="profissional_avaliacoes.php"><i class="bi bi-star me-2"></i>Avaliações</a></li>
                            <li><a class="dropdown-item" href="profissional_configurar_agenda.php"><i class="bi bi-calendar-plus me-2"></i>Configurar Agenda</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow">
                            ...
                            <li>
                                <a class="dropdown-item" href="profissional_perfil.php">
    ...
    <!-- Custom JS -->
    <script src="../JS/topo_sistema_profissional.js"></script>
